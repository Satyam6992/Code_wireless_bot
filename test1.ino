...
const char* ssid = "esp_psi_bot"; // This will show up when you turn on your mobile WIFI
const char* password = "MANSbot";  // change to more unique password
...
int enable1_2 = 13;// choose the GPIO pin of esp32
int enable3_4 = 25; // choose the GPIO pin of esp32 

// These pins are the input pins of l293d on the left side
int inp1 = 12; // Choose your GPIO pin of esp32 for the input 1
int inp2 = 14; // Choose your GPIO pin of esp32 for the input 2
// l now you must know what is the inbuilt led pin number of esp32. 
...
// if '255' is the equivalent to digital '1', and '0' is eqvivalent to digial '0', The vary the pwm values to vary the speed of the motor
      analogWrite(enable1_2, 127);   
      analogWrite(enable3_4, 127);  
    }
